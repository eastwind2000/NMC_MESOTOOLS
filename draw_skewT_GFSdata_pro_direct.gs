...
'set font 12 file /home/vgdisk01/res/grads/SupportData/newfonts/MSYHMONO.ttf'
'set font 13 file /home/vgdisk01/res/grads/SupportData/newfonts/YaHei.Consolas.1.11b.ttf'
'set font 14 file /home/vgdisk01/res/grads/SupportData/newfonts/consola.ttf'
'set font 15 file /home/vgdisk01/res/grads/SupportData/newfonts/consolab.ttf'
'set font 16 file /home/vgdisk01/res/grads/SupportData/newfonts/cour.ttf'
'set font 17 file /home/vgdisk01/res/grads/SupportData/newfonts/courbd.ttf'
'set font 18 file /home/vgdisk01/res/grads/SupportData/newfonts/segoeui.ttf'
...
* gfs_fname.1='GFS_Global_0p5deg_20120603_1200_anl.grib2.ctl'
* px.1=109
* py.1=21

* gfs_fname.2 = 'GFS_Global_0p5deg_20120621_0000_anl.grib2.ctl'
* px.2=111
* py.2=21

* gfs_fname.3 = 'GFS_Global_0p5deg_20120622_1200_anl.grib2.ctl'
* px.3=109
* py.3=21

* gfs_fname.4 = 'GFS_Global_0p5deg_20120623_1800_anl.grib2.ctl'
* px.4=112
* py.4=21

* gfs_fname.5 = 'GFS_Global_0p5deg_20130405_1800_anl.grib2.ctl'
* px.5=114
* py.5=22


* gfs_fname.6 = 'GFS_Global_0p5deg_20130429_1800_anl.grib2.ctl'
* px.6=114
* py.6=22

* gfs_fname.7 = 'GFS_Global_0p5deg_20130520_0000_anl.grib2.ctl'
* px.7=114
* py.7=22

* gfs_fname.8 = 'GFS_Global_0p5deg_20130521_0600_anl.grib2.ctl'
* px.8=112
* py.8=21

* gfs_fname.9 = 'GFS_Global_0p5deg_20130525_1200_anl.grib2.ctl'
* px.9=113
* py.9=21.5

* gfs_fname.10= 'GFS_Global_0p5deg_20130526_0600_anl.grib2.ctl'
* px.10=114
* py.10=22

* gfs_fname.11= 'GFS_Global_0p5deg_20140508_1200_anl.grib2.ctl'
* px.11=114
* py.11=21


* gfs_fname.12= 'GFS_Global_0p5deg_20140508_1200_anl.grib2.ctl'
* px.12=113
* py.12=21


* gfs_fname.13= 'GFS_Global_0p5deg_20140508_1200_anl.grib2.ctl'
* px.13=113
* py.13=21

* gfs_fname.14= 'GFS_Global_0p5deg_20140509_0600_anl.grib2.ctl'
* px.14=112
* py.14=21

* gfs_fname.15= 'GFS_Global_0p5deg_20130516_0000_anl.grib2.ctl'
* px.15=112
* py.15=21

* gfs_fname.16= 'GFS_Global_0p5deg_20130521_1800_anl.grib2.ctl'
* px.16=112
* py.16=21
*****************GFS data in UTC time***************************
...
gfs_fname.17= 'GFS_Global_0p5deg_20120623_0600_anl.grib2.ctl'
gfs_fname.18= 'GFS_Global_0p5deg_20120623_0000_anl.grib2.ctl'
...
* 'p1ev = gr2stn (lev, 'px.iens', 'py.iens')'
* 'ulev = gr2stn (ugrdprs, 'px.iens', 'py.iens')' 
* 'vlev = gr2stn (vgrdprs, 'px.iens', 'py.iens')' 
* 'tlev = gr2stn (tmpprs, 'px.iens', 'py.iens')' 

* 'spd = getwspd(ugrdprs,vgrdprs)'
* 'dir = getwdir(ugrdprs,vgrdprs)'
...
'define spd=mag(vgrdprs,ugrdprs)'      
...
rc=p_skewT(t, td, spd, dir)


'gxprint gfsdata_skewT_ENS_'iens'.ps white'
...
function p_skewT(sndtemp,snddewp,sndspd,snddir)
*************************************************************************
*
